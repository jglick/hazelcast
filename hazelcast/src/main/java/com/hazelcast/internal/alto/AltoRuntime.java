...
public class AltoRuntime {
    ...
    private TpcEngine newEngine() {
        NioEventloop.NioConfiguration nioEventloopConfig = new NioEventloop.NioConfiguration();
        nioEventloopConfig.setThreadFactory(AltoEventloopThread::new);
        nioEventloopConfig.setSchedulerSupplier(() -> {
        ...
        configuration.setEventloopConfiguration(nioEventloopConfig);
